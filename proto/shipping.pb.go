...
const file_proto_shipping_proto_rawDesc = "" +
	"\n" +
	"\x14proto/shipping.proto\x12\vhipstershop\"E\n" +
	"\bCartItem\x12\x1d\n" +
	"\n" +
	...
	"\tShipOrder\x12\x1d.hipstershop.ShipOrderRequest\x1a\x1e.hipstershop.ShipOrderResponseB\x18Z\x16shipping-service/protob\x06proto3"
...
var file_proto_shipping_proto_goTypes = []any{
	...
	(*GetQuoteRequest)(nil),   // 3: hipstershop.GetQuoteRequest
	(*GetQuoteResponse)(nil),  // 4: hipstershop.GetQuoteResponse
	(*ShipOrderRequest)(nil),  // 5: hipstershop.ShipOrderRequest
	(*ShipOrderResponse)(nil), // 6: hipstershop.ShipOrderResponse
}
var file_proto_shipping_proto_depIdxs = []int32{
	1, // 0: hipstershop.GetQuoteRequest.address:type_name -> hipstershop.Address
	...
	1, // 3: hipstershop.ShipOrderRequest.address:type_name -> hipstershop.Address
	0, // 4: hipstershop.ShipOrderRequest.items:type_name -> hipstershop.CartItem
	3, // 5: hipstershop.ShippingService.GetQuote:input_type -> hipstershop.GetQuoteRequest
	5, // 6: hipstershop.ShippingService.ShipOrder:input_type -> hipstershop.ShipOrderRequest
	4, // 7: hipstershop.ShippingService.GetQuote:output_type -> hipstershop.GetQuoteResponse
	6, // 8: hipstershop.ShippingService.ShipOrder:output_type -> hipstershop.ShipOrderResponse
